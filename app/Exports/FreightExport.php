...
class FreightExport implements FromView, WithStyles, ShouldAutoSize
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        $freights = Freight::whereBetween('date_register', [$this->startDate, $this->endDate])
        ->where('state', 'Generado') // Ajusta el estado según lo que necesites
        ->get();

        return view('points.exports.freight.freight-export', [
