...
class AdditionalExport implements FromView, WithStyles, ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        $additionals = AdditionalPoints::whereBetween('date_register', [$this->startDate, $this->endDate])
                         ->where('state', 'Generado') // Ajusta el estado según lo que necesites
                         ->get();

        return view('points.exports.additional.additional-export', [
