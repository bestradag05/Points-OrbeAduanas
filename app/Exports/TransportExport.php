...
class TransportExport implements FromView, WithStyles, ShouldAutoSize
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        $transports = Transport::whereBetween('date_register', [$this->startDate, $this->endDate])
        ->where('state', 'Generado') // Ajusta el estado según lo que necesites
        ->get();

        return view('points.exports.transport.transport-export', [
