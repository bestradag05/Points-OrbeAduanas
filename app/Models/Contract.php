...
class Contract extends Model
{
    ...
    protected $fillable = ['id_personal', 'contract_modality' , 'start_date','end_date','salary', 'id_cargo', 'id_company', 'id_contract_modalities' , 'functions', 'user_register','user_update','state'];
