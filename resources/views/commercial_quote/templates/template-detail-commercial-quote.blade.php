<div class="row mt-3">
    <div class="col-6">
        ...
        <div class="row">
            ...
            @if (in_array('Transporte', $comercialQuote->services_to_quote) && count($comercialQuote->services_to_quote) == 1)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p class="form-control-plaintext">
                                {{ $comercialQuote->customer_company_name ?? $comercialQuote->customer->name_businessname }}
                            </p>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p class="form-control-plaintext text-uppercase">
                                {{ $comercialQuote->originState->country->name }} -
                                {{ $comercialQuote->originState->name }}
                            </p>
                        </div>
    ...
    <div class="col-6 px-5">
        ...
        @if (in_array('Aduanas', $comercialQuote->services_to_quote))
            <h5 class="text-indigo mb-2 text-center py-3">
            ...
            <tbody>
                ...
                @foreach ($services as $index => $service)
                    <tr>
                        ...
                        <td>
                            <div
                                class="text-bold custom-badge status-{{ strtolower(str_replace(' ', '-', $service->state)) }}">
                                {{ $service->state }}
                            </div>
                        </td>
