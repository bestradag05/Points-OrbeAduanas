                    ...
                    <div id="formConceptsTransport" class="formConcepts row mt-4 align-items-center">
                        <div class="col-md-8">
                            <x-adminlte-select2 name="concept" id="concept_transport" label="Conceptos de Transporte"
                                ...
                                $concept->name != 'TRANSPORTE' // Excluir explícitamente
                                )
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <button type="button" class="btn btn-indigo btn-sm mt-3  w-100" onclick="addConceptQuoteTransport()">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: typeQuote === 'Flete' ?
                        `/quote/freight/${quote.id}/${actionText}` : `/quote/transport/${quote.id}/${actionText}`,
                    headers: {
