                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        class="form-control  @error('cif_value') is-invalid @enderror "
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="withdrawal_date"
                                    name="withdrawal_date" placeholder="Ingrese el destino">
                            ...
                            @if (!isset($cost_transport))
                                <div class="col-4">
                                    ...
                                    <x-adminlte-select2 name="concept" id="concept_transport" label="Conceptos"
                                        ...
                                        <option />
                                        @foreach ($concepts as $concept)
                                            @if ($concept->typeService->name == 'Transporte' && $comercialQuote->type_shipment->id == $concept->id_type_shipment)
                                                <option value="{{ $concept->id }}">{{ $concept->name }}</option>
                                            @endif
                                        @endforeach
                                    </x-adminlte-select2>
            ...
            @push('scripts')
                <script>
                    ...
                    function openModalForm(element) {
                        console.log("ejecutando el modal de sevices");
                        let selected = element.options[element.selectedIndex].text;
                        containerResult = $(`#modal${selected}`).modal('show');
                        container = containerResult[0];
                        typeService = element.value;
            ...
            {{-- Scripts para modal de Transporte --}}
