                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control CurrencyInput" id="transport_added"
                            name="transport_added" data-type="currency" placeholder="Ingrese valor de la carga"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="additional_points" name="additional_points"
                            min="0" onkeydown="preventeDefaultAction(event)" oninput="addPointsTransport(this)">
                    </div>
