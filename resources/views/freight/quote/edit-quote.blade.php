...
@section('content_header')
    <div class="d-flex justify-content-between">
        <h2>Actualizar cotizacion de flete</h2>
        <div>
...
@section('dinamic-content')
    ...
    <div class="row flex-row">
        ...
        <div class="col-12">
            ...
            <form action={{ url('/quote/freight/message/' . $quote->id) }} id="storeQuoteEdit" method="POST" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}
                @include ('freight.quote.form-quote', ['formMode' => 'edit'])
            </form>
    ...
    <div class="modal fade" id="modalQuoteFreightDocuments" tabindex="-1"
        aria-labelledby="modalQuoteFreightDocumentsLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalQuoteFreightDocumentsLabel">Documentos de Flete</h5>
                </div>
