    ...
    <x-adminlte-datatable id="table1" :heads="$heads">
        @foreach ($processes as $process)
            <tr>
                ...
                {{-- {{dd($process->commercialQuote->services_to_quote)}} --}}
                ...
                <td>{{ $process->commercialQuote->type_shipment->name . ' ' . ($process->commercialQuote->type_shipment->name === 'Marítima' ? $process->commercialQuote->lcl_fcl : '') }}
                </td>
